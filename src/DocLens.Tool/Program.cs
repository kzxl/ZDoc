...
namespace DocLens.Tool;

/// <summary>
/// Command-line entry point for DocLens. Generates a self-contained HTML API reference
...
internal static class Program
{
    ...
    {
        Console.WriteLine(
@"DocLens — generate a self-contained HTML API reference for a .NET assembly.
...
EXAMPLES:
  doclens bin/Release/netstandard2.0/MyLib.dll
  doclens MyLib.dll -o docs/index.html -t ""MyLib"" -r README.md");
    }
}
