...
{
    /// <summary>
    /// Locates the compiled DocLens.SampleLib assembly and its XML doc file, which are
    ...
    internal static class SampleAssembly
    {
        public static string DllPath
        {
            get
            {
                ...
                string path = Path.Combine(dir, "DocLens.SampleLib.dll");
                if (!File.Exists(path))
        ...
        public static Assembly Loaded => typeof(DocLens.SampleLib.Money).Assembly;
    }
}
