...
{
    /// <summary>
    /// Locates the compiled ZeroDoc.SampleLib assembly and its XML doc file, which are
    ...
    internal static class SampleAssembly
    {
        public static string DllPath
        {
            get
            {
                ...
                string path = Path.Combine(dir, "ZeroDoc.SampleLib.dll");
                if (!File.Exists(path))
        ...
        public static Assembly Loaded => typeof(ZeroDoc.SampleLib.Money).Assembly;
    }
}
